...
public class GuillotineAnimation {
    ...
    private GuillotineAnimation(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(View guillotineView, View closingView, View openingView) {
            this.guillotineView = guillotineView;
            this.openingView = openingView;
            this.closingView = closingView;
        }

        public Builder setActionBarViewForAnimation(View view) {
            this.actionBarView = view;
            return this;
        }

        public Builder setGuillotineListener(GuillotineListener guillotineListener) {
        ...
        public Builder setRightToLeftLayout(boolean isRightToLeftLayout) {
        ...
        public Builder setClosedOnStart(boolean isClosedOnStart) {
