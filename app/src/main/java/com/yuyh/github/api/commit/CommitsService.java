...
public interface CommitsService {
    ...
    Observable<List<Commit>> commits(@Path("owner") String owner, @Path("name") String repo);

    @GET("/repos/{owner}/{name}/commits")
    Observable<List<Commit>> commits(@Path("owner") String owner, @Path("name") String repo, @Query("page") int page);
    ...
    @GET("/repos/{owner}/{name}/commits")
    Observable<List<Commit>> commits(@Path("owner") String owner, @Path("name") String repo,
                                     @Query("page") int page, @Query("sha") String sha);

    @GET("/repos/{owner}/{name}/commits")
    Observable<List<Commit>> commitsByPath(@Path("owner") String owner, @Path("name") String repo,
                                           @Query("path") String path);

    @GET("/repos/{owner}/{name}/commits")
    Observable<List<Commit>> commitsByPath(@Path("owner") String owner, @Path("name") String repo,
                                           @Query("path") String path, @Query("page") int page);

    @GET("/repos/{owner}/{name}/commits")
    Observable<List<Commit>> commitsByPath(@Path("owner") String owner, @Path("name") String repo,
                                           @Query("path") String path, @Query("sha") String sha);
