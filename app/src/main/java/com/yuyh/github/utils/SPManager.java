...
public class SPManager {
    ...
    public SPManager putInt(String key, int value) {
        editor.putInt(key, value);
        editor.commit();
        return this;
    }

    public SPManager putFloat(String key, float value) {
        editor.putFloat(key, value);
        editor.commit();
        return this;
    }

    public SPManager putLong(String key, long value) {
        editor.putLong(key, value);
        editor.commit();
        return this;
    }

    public SPManager putBoolean(String key, boolean value) {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public SPManager putStringSet(String key, Set<String> value) {
